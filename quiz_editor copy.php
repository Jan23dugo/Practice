                    ...
                    <div class="settings-left">
                        ...
                        <div class="form-group">
                            <div class="checkbox-wrapper">
                                ...
                                <label for="schedule-exam">Schedule Exam (optional)</label>
                            </div>
    ...
    <div class="settings-modal-content" style="max-width: 900px;">
        <div class="settings-modal-header">
            <div class="settings-modal-title">
                ...
                <button class="close-modal" id="close-question-bank-modal">
                    <span class="material-symbols-rounded">close</span>
                </button>
            </div>
        </div>
        ...
        <div class="settings-modal-footer">
            <button type="button" class="btn btn-settings" id="cancel-import-btn">Cancel</button>
