...
$is_eligible = isset($_SESSION['is_eligible']) ? $_SESSION['is_eligible'] : false;

// Add debugging (comment out in production)
$sessionDebug = [];
foreach ($_SESSION as $key => $value) {
    if (!is_array($value) && !is_object($value)) {
        $sessionDebug[$key] = $value;
    } else {
        $sessionDebug[$key] = 'Complex data type';
    }
}
?>
...
<body>
    ...
    <div class="success-container">
        ...
        <div class="debug-info" style="display: none; margin-bottom: 20px; padding: 10px; background: #f8f8f8; border: 1px solid #ddd; border-radius: 4px;">
            <h4>Session Debug Info:</h4>
            <pre><?php print_r($sessionDebug); ?></pre>
            <p><strong>Status Variables:</strong></p>
            <ul>
                <li>Has Error: <?php echo $hasError ? 'Yes' : 'No'; ?></li>
                <li>Has Success: <?php echo $hasSuccess ? 'Yes' : 'No'; ?></li>
                <li>Is Eligible: <?php echo $is_eligible ? 'Yes' : 'No'; ?></li>
                <li>Success Message: <?php echo htmlspecialchars($successMessage); ?></li>
                <li>Error Message: <?php echo htmlspecialchars($errorMessage); ?></li>
            </ul>
            <p>To hide this debug section, edit line 219 and change style="display: none;" to style="display: block;"</p>
        </div>
