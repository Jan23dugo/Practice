                    ...
                    if (isset($_POST['grades']) && is_array($_POST['grades'])) {
                        foreach ($_POST['grades'] as $grade) {
                            ...
                            $stmt = $conn->prepare("INSERT INTO university_grading_systems 
                                (university_name, grade_value, description, min_percentage, max_percentage, is_special_grade) 
                                VALUES (?, ?, ?, ?, ?, 0)");
                    ...
                    if (isset($_POST['special_grades']) && is_array($_POST['special_grades'])) {
                        ...
                        foreach ($_POST['special_grades'] as $code => $value) {
                            if (isset($specialGradesMap[$code])) {
                                $stmt = $conn->prepare("INSERT INTO university_grading_systems 
                                    (university_name, grade_value, description, is_special_grade) 
                                    VALUES (?, ?, ?, 1)");
                                ...
                                $stmt->bind_param("sss", $university_name, $gradeValue, $description);
        ...
        <form action="" method="POST" id="addGradingForm">
            ...
            <div class="modal-body">
                <div class="form-group mb-4">
                    <label class="form-label" for="university_name">Grading System Name</label>
        ...
        <form action="" method="POST">
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="form-label" for="edit_university_name">Grading System Name</label>
    ...
    <div class="modal-content">
        ...
        <form action="" method="POST">
            <div class="modal-body">
                ...
                <p><strong>Grading System:</strong> <span id="delete_university_name"></span></p>
...
function deleteGradingSystem(id, university_name, grade) {
    document.getElementById('delete_id').value = id;
    document.getElementById('delete_university_name').textContent = university_name;
